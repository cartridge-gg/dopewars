            ...
            match slot_id {
                0 => {
                    ...
                    match tier {
                        ...
                        1 => array![
                            ...
                            ItemTierConfig { stat: 25, cost: 1_200 },
                            ItemTierConfig { stat: 50, cost: 20_000 },
                            ItemTierConfig { stat: 80, cost: 240_000 },
                        ],
                        2 => array![
                            ItemTierConfig { stat: 12, cost: 0 },
                            ItemTierConfig { stat: 28, cost: 1_280 },
                            ItemTierConfig { stat: 45, cost: 13_600 },
                            ItemTierConfig { stat: 70, cost: 200_000 },
                        ],
                        3 => array![
                            ItemTierConfig { stat: 14, cost: 0 },
                            ItemTierConfig { stat: 30, cost: 1_280 },
                            ItemTierConfig { stat: 40, cost: 8_000 },
                            ItemTierConfig { stat: 60, cost: 160_000 },
                        ],
                ...
                1 => {
                    ...
                    match tier {
                        ...
                        1 => array![
                            ItemTierConfig { stat: 10, cost: 0 },
                            ItemTierConfig { stat: 22, cost: 1_080 },
                            ItemTierConfig { stat: 48, cost: 23_400 },
                            ItemTierConfig { stat: 75, cost: 243_000 },
                        ],
                        2 => array![
                            ItemTierConfig { stat: 12, cost: 0 },
                            ItemTierConfig { stat: 26, cost: 1_260 },
                            ItemTierConfig { stat: 45, cost: 17_100 },
                            ItemTierConfig { stat: 70, cost: 225_000 },
                        ],
                        3 => array![
                            ItemTierConfig { stat: 14, cost: 0 },
                            ItemTierConfig { stat: 30, cost: 1_440 },
                            ItemTierConfig { stat: 42, cost: 10_800 },
                            ItemTierConfig { stat: 65, cost: 207_000 },
                        ],
                        _ => panic!("invalid tier"),
                    }
                },
                ...
                5 => {
                    ...
                    match tier {
                        ...
                        1 => array![
                            ...
                            ItemTierConfig { stat: 14, cost: 960 },
                            ItemTierConfig { stat: 36, cost: 26_400 },
                            ItemTierConfig { stat: 54, cost: 216_000 },
                        ],
                        2 => array![
                            ItemTierConfig { stat: 8, cost: 0 },
                            ItemTierConfig { stat: 18, cost: 1_200 },
                            ItemTierConfig { stat: 33, cost: 18_000 },
                            ItemTierConfig { stat: 50, cost: 204_000 },
                        ],
                        3 => array![
                            ItemTierConfig { stat: 10, cost: 0 },
                            ItemTierConfig { stat: 22, cost: 1_440 },
                            ItemTierConfig { stat: 30, cost: 9_600 },
                            ItemTierConfig { stat: 46, cost: 192_000 },
                        ],
                        _ => panic!("invalid tier"),
                    }
                },
