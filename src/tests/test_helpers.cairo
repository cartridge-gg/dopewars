...
pub mod test_helpers {
    ...
    const DENSHOKAN_ADDRESS_PROVABLE_DW: ContractAddress = 0x05a499a49f635d0a9379da557b3f13aeb74a1b2295944755575e6adb2b86f7dd.try_into().unwrap();

    const denshokan_dispatcher: IERC721Dispatcher = IERC721Dispatcher { contract_address: DENSHOKAN_ADDRESS_PROVABLE_DW };
