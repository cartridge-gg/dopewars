    ...
    case 'green':
      path = hasCrown ? (
        <g>
          ...
          <path fill-rule="evenodd" clip-rule="evenodd" d="M12.475 5.5249H47.525V25.5249H12.475V5.5249ZM42.5093 10.5324H37.5136V15.5299H32.4979V10.5324H27.5021V15.5299H22.4864V10.5324H17.4907V20.5174H42.5093V10.5324Z" fill="#172217"/>
          <path d="M22.5029 10.5225H17.4885V20.5275H42.5206V10.5225H37.5062V15.52H32.5118V10.5225H27.4973V15.52H22.5029V10.5225Z" fill="#11ED83"/>
        </g>
      ) : (
        <g>
          <path d="M15 15.5249H20V20.5249H15V15.5249Z" fill="#11ED83"/>
    ...
    case 'yellow':
      path = hasCrown ? (
        <g>
          ...
          <path fill-rule="evenodd" clip-rule="evenodd" d="M12.475 5.0249H47.525V25.0249H12.475V5.0249ZM42.5093 10.0324H37.5136V15.0299H32.4979V10.0324H27.5021V15.0299H22.4864V10.0324H17.4907V20.0174H42.5093V10.0324Z" fill="#172217"/>
          <path d="M22.5029 10.0225H17.4885V20.0275H42.5206V10.0225H37.5062V15.02H32.5118V10.0225H27.4973V15.02H22.5029V10.0225Z" fill="#FBCB4A"/>
        </g>
      ) : (
        <g>
