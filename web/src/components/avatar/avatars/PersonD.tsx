...
export const PersonD = ({ color, hasCrown }: AvatarPathProps) => {
  let path;
  switch (color) {
    // Green color
    case "green":
      path = hasCrown ? (
        <g>
          ...
          <path
            d="M30.05 5H15V10H10V20.05H15V25.05H20V30.05H25V35H20V40.05H25.05V35.05H30.05V30H25.05V20.05H40V25.05H45.05V20H40.05V15H30.05V5Z"
            fill="#114329"
          />
