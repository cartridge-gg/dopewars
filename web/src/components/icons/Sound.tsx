  ...
  return (
    <Icon {...props}>
      <>
        ...
        {isMuted ? (
          <path
            d="M25.9261 19.6059H28.1077V17.4264H25.9261V15.2426H28.1099V17.4242H30.2893V15.2426H32.4731V17.4264H30.2915V19.6059H32.4731V21.7897H30.2893V19.608H28.1099V21.7897H25.9261V19.6059Z"
            fill="#11ED83"
          />
        ) : (
          <path
            d="M28.1077 18.5153H25.9261V22.8807H30.2915V16.3359H32.4731V14.1522H28.1077V18.5153Z"
            fill="#11ED83"
          />
        )}
      </>
